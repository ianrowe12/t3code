...
describe("AcpRegistryAdapterV2", () => {
  it.effect("exposes T3 MCP to the native Copilot process without credentials in argv", () =>
    Effect.gen(function* () {
      ...
      yield* fixture.registerMcp(threadId, "Bearer fixture-scoped-authorization");
      ...
      assert.equal(spawn.authorization, "Bearer fixture-scoped-authorization");
        ...
        [
          {
            ...
            env: [
              ...
              { name: "T3_ACP_MCP_AUTHORIZATION", value: "Bearer fixture-scoped-authorization" },
            ],
          },
        ],
      );
